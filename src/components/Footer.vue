<template>
    <footer class="pt-7 bg-white">
        <div class="container">
            <!-- Footer 4 column -->
             <div class="my-7">
                 <a href="/become-a-sitter" class="btn btn-lg btn-primary mb-5">Become a Sitter</a>
             </div>
            ...
            <div class="row">
                <div class="col-xxl-5 col-lg-5 col-md-7">
                    <div class="mb-7 mb-xl-0">
                        ...
                        <p class="mb-5">We are all about empowering women. Our goal is to put women in charge. Men need to be viewed as the toddlers that we are.</p>
            ...
            <div class="row align-items-center">
                <div class="col-md-9">
                    <div class="small mb-3 mb-md-0">
                        ...
                        <span class="text-primary"><a href="#">Discreetly Diapered</a></span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-md-end d-flex align-items-center justify-content-md-end">
                        <div class="ms-3 d-flex gap-2">
                            <a href="https://www.instagram.com/discreetlydiapered/" class="text-reset btn btn-instagram btn-icon">
